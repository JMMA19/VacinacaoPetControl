...
export class UserDto {
    ...
    @IsString()
    @ApiProperty({ example: '', description: 'User last name for display purpose' })
    name: string;
    ...
    @IsString()
    @ApiProperty({ example: 'https://ik.imagekit.io/u3cm7hl5b//captir/profile/default_profile_img_mAJF09ccs.jpg', description: 'User profile image URL' })
